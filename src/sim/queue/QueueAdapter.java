...
public class QueueAdapter {
	...
	public QueueAdapter(int y, int u){
		this.y = y;
		this.u = u;
	}
	
	//checked
	public static Matrix Update_F(Matrix F, Matrix phy ){
		Matrix F_updated;
	...
	public static Matrix Update_theta(Matrix theta, Matrix F_updated, Matrix phy, double y_updated){
	...
	public static void main(String argv[]) {
		...
		Matrix mtheta_updated = Update_theta(mtheta,mF_updated,mphy,1);
